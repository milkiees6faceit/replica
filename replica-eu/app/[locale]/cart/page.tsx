        ...
        <div className="rounded-lg border bg-white p-4">
          <div className="grid gap-4 sm:grid-cols-[140px_1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Size M / Deposit payment / {product.estimatedDelivery}</p>
              <Button variant="link" className="mt-3 h-auto p-0">Remove</Button>
            </div>
